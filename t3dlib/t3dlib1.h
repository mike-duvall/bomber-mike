...
int Draw_BOB_To_Relative_Coordinates(BOB_PTR bob, LPDIRECTDRAWSURFACE7 dest, int xBase, int yBase);
...
void HLine32(int x1, int x2,int y, int alpha, int red, int green, int blue, UCHAR *vbuffer, int lpitch);
...
//void Draw_Text_Fill_Rect_GDI(LPRECT lprect, LPSTR lpstr, LPDIRECTDRAWSURFACE7 lpdds);
